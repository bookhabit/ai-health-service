            ...
            if("serviceWorker" in navigator){
                try{
                    ...
                    if(registrations.length){
                        ...
                        // unregister any additional ones
                        for(let i=1; i< registrations.length; i++){
                            registrations[i].unregister()
                            console.log("Unregistered redundant service worker:",registrations[i])
                        }
                    }else{
                            ...
                            if(installingWorker){
                                installingWorker.onstatechange = ()=>{
                                    if(installingWorker.state === "installed"){
                                        toast.success("New update available! Please refresh page to update")
                                    }
                                }
                            }
                        }
